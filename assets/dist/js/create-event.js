...
$(document).ready(function () {
    ...
    $("select").change(function () {
        ...
        if ($(this).val() == "price") {
            $('.row-for-select .form-column').css('display', 'inline-block')
        } else {
            $('.row-for-select .form-column').css('display', 'none')
        }
    });
    ...
    if ('.check.active') {
        $('.check.active .checkbox-item').css('display', 'none')
        $('.check.active .item').css('display', 'flex')
    }
